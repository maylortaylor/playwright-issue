...
declare const cesiumProps_50: readonly ["bounceAnimationTime", "enableCollisionDetection", "enableInputs", "enableLook", "enableRotate", "enableTilt", "enableTranslate", "enableZoom", "inertiaSpin", "inertiaTranslate", "inertiaZoom", "lookEventTypes", "maximumMovementRatio", "maximumZoomDistance", "minimumCollisionTerrainHeight", "minimumPickingTerrainHeight", "minimumTrackBallHeight", "minimumZoomDistance", "rotateEventTypes", "tiltEventTypes", "translateEventTypes", "zoomEventTypes", "minimumPickingTerrainDistanceWithInertia"];
...
declare const cesiumReadonlyProps: readonly ["showOutline", "cullWithChildrenBounds", "debugHeatmapTilePropertyName", "enableDebugWireframe", "modelUpAxis", "modelForwardAxis", "projectTo2D", "enableShowOutline"];
...
declare const cesiumReadonlyProps_9: readonly ["rectangle", "maximumAnisotropy", "minimumTerrainLevel", "maximumTerrainLevel", "readyEvent"];
...
export declare const createCesiumComponent: <Element_1, Props extends {}, State = any>({ renderContainer, noChildren, containerProps, defaultProps, ...options }: CesiumComponentOptions<Element_1, Props, State>) => CesiumComponentType<Element_1, Props>;
...
declare type EntityOtherProps = EventProps<EventTarget_2> & {
    children?: ReactNode;
...
declare type ImageryLayerCesiumReadonlyProps = PickCesiumProps<Target_8, typeof cesiumReadonlyProps_9>;
...
export declare const useCesiumComponent: <Element_1, Props extends RootComponentInternalProps, State = any>({ name, create, destroy, provide, update, cesiumReadonlyProps, cesiumEventProps, otherProps, setCesiumPropsAfterCreate, useCommonEvent, useRootEvent, }: Options<Element_1, Props, State>, props: Props, ref: any) => [Partial<ResiumContext> | undefined, boolean, RefObject<HTMLDivElement>];
